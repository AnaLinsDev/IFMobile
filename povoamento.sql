...
/*POR SEGURANÇA E PARA EVITAR QUE O SERIAL DÊ CONFLITO 
COM O BANCO DE DADOS DAS EQUIPES ANTERIOR, POR OBSEQUIO,
REINICIE O SERIAL DAS TABELAS COM O CÓDIGO ABAIXO*/
ALTER SEQUENCE cobertura_idRegiao_seq RESTART WITH 1;
ALTER SEQUENCE operadora_idoperadora_seq RESTART WITH 1;
ALTER SEQUENCE cidade_idcidade_seq RESTART WITH 1;
ALTER SEQUENCE tarifa_idtarifa_seq RESTART WITH 1;
ALTER SEQUENCE cidade_idcidade_seq RESTART WITH 1;
...
--tabela cobertura
-- No dicionário de dados a coluna idRegiao estava do tipo char(2), enquanto na criação do banco ela estava como SERIAL, então optamos por seguir o SCRIPT criado pelo professor.

INSERT INTO cobertura (idRegiao, descricao) VALUES (1, 'Regional Nordeste area 1'); -- 1
INSERT INTO cobertura (idRegiao, descricao) VALUES (2, 'Regional Nordeste area 2'); -- 2
INSERT INTO cobertura (idRegiao, descricao) VALUES (3, 'Regional Norte');           -- 3
INSERT INTO cobertura (idRegiao, descricao) VALUES (4, 'Regiao Sudeste area 1');    -- 4
INSERT INTO cobertura (idRegiao, descricao) VALUES (5, 'Regiao Sudeste area 2');    -- 5
INSERT INTO cobertura (idRegiao, descricao) VALUES (6, 'Regiao Sul');               -- 6
INSERT INTO cobertura (idRegiao, descricao) VALUES (7, 'Regiao Centro-Oeste');
...
insert into operadora (nome) values ('NOS');
insert into operadora (nome) values ('NOWO');
insert into operadora (nome) values ('MEO');
insert into operadora (nome) values ('NEXTEL');
insert into operadora (nome) values ('EMBRATEL');
insert into operadora (nome) values ('SERCOMTEL');



-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
-- TABELA: Estados
-- Contribuição: professor Alex Sandro
-- -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
-- Regiao Norte
...
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (1, 'Prézão', 0, 0, 0);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (2, 'Flex', 60, 30, 35.00);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (3, 'Controle', 90, 60, 55.00);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (4, 'Pós-pago Simples', 120, 95, 64.99);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (5, 'Pós-pago Melhorado', 150, 120, 78.00);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (6, 'Pós Premium', 200, 150, 85.00);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (7, 'Pós Semi-Infinitus', 1000, 500, 120.00);
insert into plano (idPlano, descricao, fminIn, fminout, valor) values (8, 'Pós Infinitus', 5000, 3000, 219.98);
...
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('83983112345', 1, 1, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('21985112346', 2, 2, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('95991212345', 3, 3, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('85991112346', 3, 3, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('63995212345', 4, 4, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('85994112345', 5, 5, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('83994212346', 5, 6, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('84986112345', 7, 4, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('83971212345', 8, 8, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('98980212345', 9, 7, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('11993267985', 10, 1, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('68985116509', 2, 2, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('81985278729', 2, 3, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('21991280231', 3, 4, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('85995142339', 4, 5, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('63994244349', 5, 6, 'S', 'N');
insert into chip (idNumero, idOperadora, idPlano, ativo, disponivel) values ('85989212342', 6, 8, 'S', 'N');


-- TABELA: cliente_chip

insert into cliente_chip (idNumero, idCliente) values ('83983112345', 1);
insert into cliente_chip (idNumero, idCliente) values ('21985112346', 2);
insert into cliente_chip (idNumero, idCliente) values ('95991212345', 3);
insert into cliente_chip (idNumero, idCliente) values ('85991112346', 4);
insert into cliente_chip (idNumero, idCliente) values ('63995212345', 10);
insert into cliente_chip (idNumero, idCliente) values ('85994112345', 2);
insert into cliente_chip (idNumero, idCliente) values ('83994212346', 8);
insert into cliente_chip (idNumero, idCliente) values ('84986112345', 7);
insert into cliente_chip (idNumero, idCliente) values ('83971212345', 3);
insert into cliente_chip (idNumero, idCliente) values ('98980212345', 5);

insert into cliente_chip (idNumero, idCliente) values ('11993267985', 1);
insert into cliente_chip (idNumero, idCliente) values ('68985116509', 3);
insert into cliente_chip (idNumero, idCliente) values ('81985278729', 3);
insert into cliente_chip (idNumero, idCliente) values ('21991280231', 2);

insert into cliente_chip (idNumero, idCliente) values ('85995142339', 1);
insert into cliente_chip (idNumero, idCliente) values ('63994244349', 3);
insert into cliente_chip (idNumero, idCliente) values ('85989212342', 2);
...
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2009-08-03 11:32:09', '83983112345', 305, 77, 416, 22, 92, 263, 'S');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2017-10-02 09:08:13', '98980212345', 439, 55, 203, 35, 98, 166, 'N');
...
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2019-02-04 00:33:02', '95991212345', 326, 225, 328, 95, 26, 343, 'S');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2010-06-25 17:15:42', '85991112346', 433, 139, 423, 88, 23, 287, 'S');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2014-09-01 01:13:24', '63995212345', 370, 288, 46, 85, 27, 201, 'N');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2006-09-14 14:23:00', '85994112345', 337, 248, 34, 57, 26, 229, 'N');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2007-03-17 21:11:19', '83994212346', 500, 248, 182, 12, 79, 136, 'S');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2000-03-12 12:52:27', '84986112345', 424, 252, 323, 73, 69, 135, 'N');
insert into  fatura (referencia, idNumero, valor_plano, tot_min_int, tot_min_ext, tx_min_exced, tx_roaming, total, pago) values ('2004-06-07 10:48:28', '83971212345', 287, 255, 400, 86, 87, 204, 'N');

-- TABELA: auditoria

insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (1, 21985112346, '25/8/2009', '27/9/2013');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (2, 83983112345, '29/7/2008', '26/12/2016');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (3, 98980212345, '30/12/2001', '8/3/2008');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (4, 84986112345, '10/4/2003', '10/8/2009');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (5, 98980212345, '25/1/2002', '5/4/2008');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (6, 98980212345, '28/3/2016', '4/1/2020');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (7, 85994112345, '6/5/2013', '6/3/2019');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (8, 63995212345, '8/3/2006', '11/6/2010');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (9, 85991112346, '18/7/2001', '25/12/2009');
insert into auditoria (idCliente, idNumero, dataInicio, dataTermino) values (10, 21985112346, '9/8/2002', '11/12/2008');

-- TABELA: ligacao

insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2001-06-26 14:11:00', '83983112345', 'PB', 83971212345, 'PB', '2:52:06');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2013-10-07 16:12:51', '83983112345', 'PB', 95991212345, 'RR', '5:37:54');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2016-04-15 16:23:27', '98980212345', 'MA', 95991212345, 'RR', '1:09:04');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2019-12-22 12:48:20', '21985112346', 'RJ', 84986112345, 'RN', '0:22:03');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2020-08-09 05:42:36', '95991212345', 'RR', 98980212345, 'MA', '0:13:18');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2015-12-29 17:25:36', '83971212345', 'PB', 98980212345, 'MA', '1:21:09');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2020-04-08 16:16:51', '63995212345', 'TO', 83994212346, 'PB', '1:38:06');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2013-04-30 14:13:16', '85994112345', 'CE', 83983112345, 'PB', '2:43:26');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2017-12-10 15:15:27', '83994212346', 'PB', 83983112345, 'PB', '1:19:06');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2009-01-13 15:38:26', '84986112345', 'RN', 63995212345, 'TO', '5:17:18');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2012-05-11 14:48:18', '83971212345', 'PB', 63995212345, 'TO', '0:02:52');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2001-12-25 05:00:29', '85994112345', 'CE', 95991212345, 'RR', '3:22:11');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2009-05-17 04:01:10', '95991212345', 'RR', 83994212346, 'PB', '0:13:37');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2018-01-13 17:39:56', '83994212346', 'PB', 63995212345, 'TO', '0:00:43');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2004-01-06 22:47:47', '63995212345', 'TO', 98980212345, 'MA', '4:17:07');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2018-02-02 13:51:19', '95991212345', 'RR', 83971212345, 'PB', '3:22:44');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2017-06-16 21:16:19', '83971212345', 'PB', 95991212345, 'RR', '5:35:03');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2015-04-09 03:35:29', '83983112345', 'PB', 21985112346, 'RJ', '2:48:10');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2007-03-30 03:42:31', '95991212345', 'RR', 21985112346, 'RJ', '3:07:46');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2015-10-11 00:53:28', '21985112346', 'RJ', 83983112345, 'PB', '5:01:15');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2007-03-29 10:42:31', '95991212345', 'RR', 21985112346, 'RJ', '0:07:00');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2007-03-28 13:42:31', '95991212345', 'RR', 21985112346, 'RJ', '1:03:26');
insert into ligacao (data, chip_emissor, ufOrigem, chip_receptor, ufDestino, duracao) values ('2007-02-28 13:42:31', '95991212345', 'RR', 21985112346, 'RJ', '3:03:26');
